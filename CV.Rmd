...
# About
I am a philosopher and sociologist of science working in the chair of Philosophy and History of Science and Technology at the Technical University Munich. My core research areas include: the philosophy of (open) data, the sociology of (scientific) standards, and environmental intelligence. I draw on mixed methods such as quantitative modelling, ethnographic observations and semi structured interviews in order to understand the historical, philosophical, social and technical dimensions 
...
tribble(
  ...
  "Post-Doctoral Researcher", "2025", "Technical University Munich", "Munich, Germany"
) %>% 
  detailed_entries(Degree, Year, Institution, Where)
```
...
- Sheehan, N., Botta, F. and Leonelli, S. (2024) Unrestricted Versus Regulated Open Data Governance: A Bibliometric Comparison of SARS-CoV-2 Nucleotide Sequence Databases. Data Science Journal, 23: 29, pp. 1–29. DOI: https://doi.org/10.5334/dsj2024-029

- Sheehan, N., & Leonelli, S. (2025). Reconciling data actionability and accountability in global health research: The case of SARS-CoV-2. Global Public Health, 20(1). https://doi.org/10.1080/17441692.2024.2436422

- Chatikobo, T., Griffiths, F., Hayden, N., Leeming, G., Mishra, A., Morris, E., Schirru, L., Sheehan, N., Williams, A. & Sekalala, S. (2026). Open Science, Health Data and Epistemic Harms: A Multidisciplinary Reflection. Data Science Journal, 25(1), 15-15. https://doi.org/10.5334/dsj-2026-015

- Sheehan, N. (2026). The Sequence and the Standard: An Account of Participatory Informational Format Exclusion (PIFE). Social Epistemology, 1–13. https://doi.org/10.1080/02691728.2026.2682153
...
- Sheehan, N (2024). C2A: contains the code and data used to produce the results presented in the paper "Unrestricted versus Regulated Open Data Governance: A Bibliometric Comparison of SARS-CoV-2 Nucleotide Sequence Databases".
- Alcalay, R. B., Sheehan, N., & Trappes, R. (2025). conceptcartography (Version 1.0.0) [Computer software]. https://doi.org/10.5281/zenodo.1234
- Sheehan, N (2026). Pianeta Lab - Storie di Insetti: Multi-modal stories of insects.
...
tribble(
  ...
  2024, "Understanding Life in a Changing Planet, Exeter", "Between Open and Closed Data: A metascientific study on global health data practices",
  2024, "Philosophy of Science Association, New Orleans", "Particpatory Informational Format Exclusion", 
  2025, "European Bioinformatics Institute, Hinxton", "A journey from data ethics to AI governance", 
  2025, "International Society for the History, Philosophy and Social Studies of biology, Porto", "Data Brokers in Broken Data Communities",
  2026, "Research Data Alliance 26th Plenary","The Ethical Data Initiative",
  2026, "Society for Philosophy of Science in Practice, Cambridge", "A Philosophy of Data Formats"
